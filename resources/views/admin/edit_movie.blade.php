...
<main>
      <div class="col-12 ">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <form action="{{route('update_movie', $movie->id)}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="mb-2">
                  <label for="exampleInputEmail1" class="form-label">Upload Gambar</label>
             
                  <img class="img-detail" id="blah"   src="{{ asset('storage/'. $movie->gambar)}}" >
              </div>
              <div class="input-group mb-5">
                  <div class="custom-file">
                    <input type="file" name="gambar" value="{{ asset('storage/'. $movie->gambar)}}"
                     class="custom-file-input @error('gambar') is-invalid @enderror" 
                     onchange="readURL(this);"
                     >
                     <input type="hidden" name="old_gambar" value="{{$movie->gambar}}">
          ...
          <div class="col-md-8">
                  ...
                  <div class="mb-3">
                    ...
                    value="{{ old('nama_movie', $movie->nama_movie) }}"
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                          ...
                          value="{{ old('tgl_rilis', $movie->tgl_rilis) }}"
                          >
                      ...
                      <div class="mb-3">
                        ...
                        <div class="form-check">
                          @php 
                          $result = $kategori_movie->checkbox($movie->id,$kat->id );
                        @endphp
                            <input class="form-check-input" name="id_kategori[]" value="{{$kat->id}}" type="checkbox"  id="flexCheckDefault" {{ old('id_kategori[]', $result) ? 'checked' : '' }} />
